...
# todo change output directory to correct dir
# fst::write_fst(mv_res_pers, path = here::here("output/mv_emotion/"))
...
spec_plot_dens_pers <- cowplot::plot_grid(plot_out_dens_pers, plot_spec_dens_pers, 
                   nrow = 2, align = "h",
                   rel_heights = c(0.5,1))
ggsave("spec_plot_dens_pers.pdf", spec_plot_dens_pers, path = here("figures/"),
       device = "pdf", height = 16, width = 16)
